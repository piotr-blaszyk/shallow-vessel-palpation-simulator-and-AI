...
def main():
    # Test dot notation
    dot_value = SYSTEM_PARAMS.optimisation_update_steps.vitactip.youngs_modulus
    print("Dot notation value:", dot_value)
    
    # Test bracket notation
    bracket_value = SYSTEM_PARAMS.optimisation_update_steps.vitactip['youngs_modulus']
    print("Bracket notation value:", bracket_value)
    
    # Test mixed notation
    mixed_value = SYSTEM_PARAMS.optimisation_update_steps['vitactip'].youngs_modulus
