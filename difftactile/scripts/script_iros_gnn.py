...
can be trained from scratch or evaluated from the published checkpoint:
    ...
    python -m difftactile.scripts.script_iros_gnn A-to-B --train
    python -m difftactile.scripts.script_iros_gnn A-to-B --eval
    python -m difftactile.scripts.script_iros_gnn C-to-B --train
    python -m difftactile.scripts.script_iros_gnn A-to-C --eval
...
See run_scenario() in difftactile/cnn/iros_gnn.py for what each one does.
"""
