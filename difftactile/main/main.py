...
# Error accumulation for integral term
    ...
    def print_gradients(self):
        ...
        print(f'deformed_markers (grad) max: {self.vitactip.deformed_markers.grad.to_numpy().max()}')
        print(f'deformed_markers (val) max: {self.vitactip.deformed_markers.to_numpy().max()}')
        ...
        print(f'vertex_velocities (grad) max: {self.vitactip.vertex_velocities.grad.to_numpy().max()}')
        print(f'vertex_velocities (val) max: {self.vitactip.vertex_velocities.to_numpy().max()}')
        print(f'contact_forces_on_vertices (grad) max: {self.vitactip.contact_forces_on_vertices.grad.to_numpy().max()}')
        print(f'contact_forces_on_vertices (val) max: {self.vitactip.contact_forces_on_vertices.to_numpy().max()}')
