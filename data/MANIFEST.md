...
(`script_main`), but doing so takes about an hour of GPU time, and a user who
...
|---|---:|---|
| `difftactile/output/training_data/pickle_20250901_220921_reordered_dense/` | ~245 MB | 500 simulated trajectories. Generable via `script_main` but takes ~1 h GPU; shipped for convenience. |
...
Excluding these takes the bundle from **4.5 GB to roughly 250 MB** without
